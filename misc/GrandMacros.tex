%Maintained by Kazuki Yoshida since 2016

%%%%%%%%%%%%%%%%%%%%%%%%%%
% Addition by K Yoshida  %
%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand\floor[1]{\lfloor#1\rfloor}
\newcommand\ceil[1]{\lceil#1\rceil}
% Independence sign as used in causal inference
\newcommand{\ind}{\mathrel{\text{\scalebox{1.07}{$\perp\mkern-10mu\perp$}}}}
% Addition to R for reals
\def\nat{{\mathbb N}}
\def\rat{{\mathbb Q}}
\def\comp{{\mathbb C}}
% argmin/argmax
...
\usepackage{accents}
\newcommand{\unbar}[1]{\underaccent{\bar}{#1}}

% Blackboard bold roman alphabets
\def\Abb{\mathbb{A}}
\def\Bbb{\mathbb{B}}
\def\Cbb{\mathbb{C}}
\def\Dbb{\mathbb{D}}
...
%Last Modified : Time-stamp: <02/28/05 4pm T. Cai>
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                            %
%        GrandMacros.tex                     %
%                                            %
