...
;;; ediff
 ...
 '(ediff-current-diff-Ancestor ((t (:foreground "Black" :background "VioletRed"))))
 '(ediff-current-diff-B ((t (:foreground "DarkOrchid" :background "Yellow"))))
 '(ediff-current-diff-C ((t (:foreground "Navy" :background "Pink"))))
...
;;; magit
 '(magit-section-heading ((t (:foreground "lightsalmon" :background "Gray20" :height 1.1 :weight ultra-bold))))
 '(magit-section-highlight ((t (:background "Gray10"))))
 '(magit-branch-local ((t (:foreground "LightSkyBlue1" :box (:line-width 1)))))
 ...
 '(magit-diff-removed ((t (:foreground "firebrick3"))))
